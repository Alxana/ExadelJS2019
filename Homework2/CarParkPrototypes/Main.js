...
let car = new Car("fd234b", "VW", "Polo", 4);
let trailer = new Trailer("abc444b", "Mercedes", "Actros", 8.5, 250);
let carTransporter = new CarTransporter("nm123gh", "Volvo", "VAH 300", 6, 10);
let car2 = new Car("ab123KL", "Nissan", "X-Trail", 4);
